import { type Holding, type CapitalGainsData } from '../types/index';

// Mock delay for realistic API simulation
const delay = (ms: number) => new Promise(resolve => setTimeout(resolve, ms));

export const mockHoldingsAPI = async (): Promise<Holding[]> => {
...
export const mockCapitalGainsAPI = async (): Promise<CapitalGainsData> => {
  await delay(600);
